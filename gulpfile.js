...
gulp.task('deploy', function() {
    ...
    .pipe(conn.dest('/public_html/kaminskiydmitriy.com/webmaster'));
});
...
gulp.task('rsync', function() {
    ...
    .pipe(rsync({
        //chmod: 'ugo=rwX',
        root: 'dist/',
        hostname: 'ftp.kaminskiydmitriy.com',
        destination: '/public_html/kaminskiydmitriy.com/webmaster',
        archive: true,
        silent: false,
        compress: true
    }));
...
// ];
// return gulp.src(globs, {buffer: false})
// .pipe(conn.dest('www/develop-site.ru/public_html/smitler'));
